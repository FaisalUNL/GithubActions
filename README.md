[![Run App FaisalAlmaaini](https://github.com/FaisalUNL/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/FaisalUNL/GithubActions/actions/workflows/run-app.yaml)
